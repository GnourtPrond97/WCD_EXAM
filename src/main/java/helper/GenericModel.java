...
//                switch (field.getType().getSimpleName()) {
//                    case SQLConstant.PRIMITIVE_STRING:
//                        field.set(objResult, resultSet.getString(columnInfor.columnName().trim()));
//                        break;
//                    case SQLConstant.PRIMITIVE_INT:
//                        // set giá trị của trường đó cho đối tượng mới tạo ở trên.
//                        field.set(objResult, resultSet.getInt(columnInfor.columnName().trim()));
//                        break;
//                    case SQLConstant.PRIMITIVE_DOUBLE:
//                        field.set(objResult, resultSet.getDouble(columnInfor.columnName().trim()));
//                        break;
//                }
//
//            }
            for (Field field : fields) {
                ...
                if (field.isAnnotationPresent(Id.class)) {
                    ...
                    return findById((Integer) field.get(obj));
